...
This repo contains Ansible plays and scripts to automate the installation of Red Hat OpenShift 3.11 in a disconnected environment
...
vSphere virtualization host 6.7

Red Hat Ansible Engine 2.7.2
