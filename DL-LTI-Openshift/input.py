...
usrtext = input("Enter HTTP_file_path ( Download the Rhel 8.9 OS image and store it in /usr/share/nginx/html/ location of the installer machine ) ( Example: /usr/share/nginx/html/ ): " + "\n");
f.write("\n   HTTP_file_path: " +usrtext);

usrtext = input("Enter Operating System type ( Example: rhel8 ): " + "\n");
f.write("\n   OS_type: " +usrtext);

usrtext = input("Enter Operating System Image name ( Example: rhel-8.9-x86_64-dvd.iso )  : " + "\n");
...
usrtext = input("Enter the ocp version (Example: 4.15.3) : " + "\n");
f.write("\n\nocp_version: " +usrtext);
