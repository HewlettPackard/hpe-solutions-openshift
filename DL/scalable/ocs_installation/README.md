...
This section provides details on the scripts developed to automate the installation of OCS 4.4 operator on the OCP 4.5 cluster. The scripts used to deploy OCS can be found in the installer machine at *$BASE_DIR/ocs_installation*.
